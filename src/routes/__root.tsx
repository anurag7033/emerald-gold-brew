  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <Link to="/" className="mt-6 inline-flex rounded-md bg-gold px-4 py-2 text-sm font-medium">
          Go home
        </Link>
      </div>
    </div>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <button onClick={() => { router.invalidate(); reset(); }} className="mt-6 rounded-md bg-gold px-4 py-2 text-sm font-medium">
          Try again
        </button>
      </div>
    </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Tea Square Cafe — Premium tea, fresh coffee, delicious food and a relaxing luxury ambience." },
